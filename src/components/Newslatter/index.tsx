  ...
  return (
    <section>
      <div className="container">
        <div className="relative z-10 overflow-hidden rounded bg-gradient-to-t from-transparent to-[#F0F2F9] px-5 py-[70px] dark:to-gray-dark">
          <div className="mx-auto w-full max-w-[530px] text-center">
            <h2 className="mb-4 text-[26px] font-bold text-black dark:text-white sm:text-4xl">
            ...
            <div className="absolute bottom-0 right-0 -z-10">{graphic_2}</div>
          </div>
        </div>
      </div>
    </section>
